...
BEATS = {
    "greet": "First contact in this room. Say hi like you've been meaning to message them, then ask ONE small ordinary question — but it has to be a question that would make sense to a complete stranger: 'hows your day', 'you still in the new place'. You have never been told a single specific thing about their life, so you cannot ask about their tap, their dog, their coffee machine or anything else you would have to have been told. Inventing one is the worst mistake available to you here. Do not explain who you are or how you know them.",
